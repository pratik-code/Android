...
public class CallRecordService extends Service implements Recorder.OnStateChangedListener {
	private static final String TAG = "AtulCallRecordService";
          ...
          listener = new PhoneStateListener() {
            ...
            public void onCallStateChanged(int state, String incomingNumber) {
              ...
              case TelephonyManager.CALL_STATE_OFFHOOK:
            	...
            	startRecording_Atul (incomingNumber);
                break;
...
//              textOut2.append(String.format("\n incomingNumber: %s", incomingNumber));
	...
	void startRecording_Atul (String incomingNumber) {
        Log.e (TAG, "ATUL >>> Inside startRecording ");
    	if (AUDIO_AMR.equals(mRequestedType)) {
            mRemainingTimeCalculator.setBitRate(BITRATE_AMR);
            mRecorder.startRecording(MediaRecorder.OutputFormat.RAW_AMR, ".amr", this, mAudioSourceType, MediaRecorder.AudioEncoder.AMR_NB, incomingNumber);
        } else if (AUDIO_3GPP.equals(mRequestedType)) {
            mRemainingTimeCalculator.setBitRate(BITRATE_3GPP);
            mRecorder.startRecording(MediaRecorder.OutputFormat.THREE_GPP, ".3gpp", this, mAudioSourceType, MediaRecorder.AudioEncoder.AMR_NB, incomingNumber);
        } else {
    ...
    void stopRecording_Atul () {
        Log.e (TAG, "ATUL >>> Inside stopRecording ");
