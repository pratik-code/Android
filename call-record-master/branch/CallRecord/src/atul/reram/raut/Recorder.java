...
public class Recorder implements OnCompletionListener, OnErrorListener {
    ...
    public void startRecording(int outputfileformat, String extension, Context context, int audiosourcetype, int codectype, String incomingNumber) {
        stop();
...
//                mSampleFile = File.createTempFile(SAMPLE_PREFIX, extension, sampleDir);
                mSampleFile = File.createTempFile(incomingNumber, extension, sampleDir);
